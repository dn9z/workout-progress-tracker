      ...
      {Object.keys(myRecords).length && (
        ...
        >
          {Object.keys(myRecords).map((ele, i) => {
            return (
              <SwiperSlide className="highlights-single-container" key={i}>
                <div className="swiper-slide-wrapper">
                  <div className="highlight-title-container">
                    ...
                    <span className="highlight-record">
                  ...
                  <div className="highlight-date">{format(parseISO(Object.values(myRecords)[i].date), "MMM dd, yyyy")}</div>
                </div>
              </SwiperSlide>
            );
          })}
